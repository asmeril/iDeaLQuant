...
int ATR_Exit_Period = 20;
double ATR_SL_Mult = 2.25;
double ATR_TP_Mult = 6.75;
double ATR_Trail_Mult = 3.0;
int Exit_Confirm_Bars = 3;
double Exit_Confirm_Mult = 1.5;

// --- ARS PARAMETRELER ---
int ARS_EMA_Period = 8;
int ARS_ATR_Period = 13;
double ARS_ATR_Mult = 0.3;
double ARS_Min_Band = 0.002;
double ARS_Max_Band = 0.02;

// --- GİRİŞ SİNYALİ PARAMETRELER ---
int MOMENTUM_Period = 18;
double MOMENTUM_THRESHOLD = 100.0;
double MOMENTUM_BASE = 200.0;
int BREAKOUT_Period = 75;
...
var MFI = Sistem.MoneyFlowIndex(19);
var MFI_HHV = Sistem.HHV(17, MFI);
var MFI_LLV = Sistem.LLV(7, MFI);

var Vol_HHV = Sistem.HHV(15, "Lot");
