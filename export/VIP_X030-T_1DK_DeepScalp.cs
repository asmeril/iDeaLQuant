...
// Layer 2
float ST_FACTOR = 2.25f;
int ST_HHV_PERIOD = 10; // ATR Period in Python 
int ST_ATR_PERIOD = 14;
int EMA_FAST_PERIOD = 60;
int EMA_SLOW_PERIOD = 92;
// Layer 3
int TOMA_PERIOD = 1;
float TOMA_OPT = 2.9f;
int HHV_TETIK_PERIOD = 65;
int LLV_TETIK_PERIOD = 100;
// Layer 4
int MFI_PERIOD = 90;
int MFI_HHV_PERIOD = 28;
int MFI_LLV_PERIOD = 28;
float MFI_LONG = 47.5f;
float MFI_SHORT = 40.0f;
float VOL_RATIO = 0.5f;
// Layer 5
int ATR_PERIOD = 14;
