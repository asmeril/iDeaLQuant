...
int ATR_Exit_Period = 10;
double ATR_SL_Mult = 4.0;
double ATR_TP_Mult = 11.0;
double ATR_Trail_Mult = 5.0;
int Exit_Confirm_Bars = 3;
double Exit_Confirm_Mult = 0.875;

// --- ARS PARAMETRELER ---
int ARS_EMA_Period = 9;
int ARS_ATR_Period = 24;
double ARS_ATR_Mult = 0.9;
double ARS_Min_Band = 0.007;
double ARS_Max_Band = 0.01;

// --- GİRİŞ SİNYALİ PARAMETRELER ---
int MOMENTUM_Period = 19;
double MOMENTUM_THRESHOLD = 100.0;
double MOMENTUM_BASE = 200.0;
int BREAKOUT_Period = 12;
...
var MFI = Sistem.MoneyFlowIndex(16);
var MFI_HHV = Sistem.HHV(20, MFI);
var MFI_LLV = Sistem.LLV(30, MFI);

var Vol_HHV = Sistem.HHV(37, "Lot");
