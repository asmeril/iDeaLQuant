...
double ATR_TP_Mult = 6.5;
double ATR_Trail_Mult = 4.75;
int Exit_Confirm_Bars = 3;
double Exit_Confirm_Mult = 0.5;

// --- ARS PARAMETRELER ---
int ARS_EMA_Period = 2;
int ARS_ATR_Period = 37;
double ARS_ATR_Mult = 0.6;
double ARS_Min_Band = 0.004;
double ARS_Max_Band = 0.021;

// --- GİRİŞ SİNYALİ PARAMETRELER ---
int MOMENTUM_Period = 25;
double MOMENTUM_THRESHOLD = 100.0;
double MOMENTUM_BASE = 200.0;
int BREAKOUT_Period = 22;
...
var MFI_HHV = Sistem.HHV(30, MFI);
var MFI_LLV = Sistem.LLV(20, MFI);

var Vol_HHV = Sistem.HHV(10, "Lot");
