...
public class formParaBir : Form
{
	public static formParaBir Referans;

	public static string IdealParaBirStartString;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_Resize(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_SizeChanged(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaBir_FormClosed(object sender, FormClosedEventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private static void ConnectIdealParaBir()
	{
	}
