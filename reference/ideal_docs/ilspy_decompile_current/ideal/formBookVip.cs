...
public class formBookVip : FormControl
{
	...
	private List<cxVipOrder.OrderRecord> DataList;
	...
	private ToolStripMenuItem menuMainGrafikExportMulti;

	[MethodImpl(MethodImplOptions.NoInlining)]
	public formBookVip(int leftX, int topX, cxPage.Trade pageparamsX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_Activated(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_Deactivate(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVip_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_MouseWheel(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formVipBook_SizeChanged(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuMainGrafikExportMulti_Click(object sender, EventArgs e)
	{
	}
