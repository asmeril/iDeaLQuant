...
public class formTradeVip : FormControl
{
	...
	private int MoneyflowLastBarNo;
	...
	private ToolStripMenuItem menuSymbolAllMarketsFutures;

	private ToolStripMenuItem menuSymbolAllMarketsOptions;

	private ToolStripSeparator toolStripSeparator61;

	private ToolStripMenuItem menuSymbolMainAll;

	private ToolStripMenuItem menuSymbolMainFutures;

	private ToolStripMenuItem menuSymbolMainOptions;

	private ToolStripSeparator toolStripSeparator8;

	private ToolStripMenuItem menuSymbolOzelAll;

	private ToolStripMenuItem menuSymbolOzelFutures;

	private ToolStripMenuItem menuSymbolOzelOptions;

	private ToolStripSeparator toolStripSeparator59;

	private ToolStripMenuItem menuSymbolIlanAll;

	private ToolStripMenuItem menuSymbolIlanFutures;

	private ToolStripMenuItem menuSymbolIlanOptions;

	private ToolStripSeparator toolStripSeparator60;

	private ToolStripMenuItem menuSymbolMainActive;
	...
	public formTradeVip(int leftX, int topX, cxPage.Trade fieldsX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_Activated(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_Deactivate(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_MouseLeave(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_MouseWheel(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTradeVip_SizeChanged(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolAllMarketsFutures_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolAllMarketsOptions_Click(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolMainAll_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolMainFutures_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolMainOptions_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolOzelAll_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolOzelFutures_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolOzelOptions_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolIlanAll_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolIlanFutures_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolIlanOptions_Click(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void menuSymbolMainActive_Click(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void IslemReceived(IslemStruct1 tradeitemX)
	{
	}
