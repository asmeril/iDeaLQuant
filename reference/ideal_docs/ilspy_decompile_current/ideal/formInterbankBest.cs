...
public class formInterbankBest : FormControl
{
	...
	public formInterbankBest(int leftX, int topX, cxPage.Interbank pageparamsX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formInterbankBest_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formInterbankBest_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formInterbankBest_Activated(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formInterbankBest_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formInterbankBest_SizeChanged(object sender, EventArgs e)
	{
	}
