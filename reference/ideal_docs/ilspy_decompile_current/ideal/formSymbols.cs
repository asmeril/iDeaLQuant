...
public class formSymbols : Form
{
	...
	private TextBox textFilter3;

	private TextBox textFilter2;

	private Label label1;

	private TextBox textFilter1;
	...
	private Label labelSymbolCount;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formSymbols_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formSymbols_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formSymbols_MouseWheel(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formSymbols_SizeChanged(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void textFilter1_KeyPress(object sender, KeyPressEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void textFilter2_KeyPress(object sender, KeyPressEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void textFilter3_KeyPress(object sender, KeyPressEventArgs e)
	{
	}
