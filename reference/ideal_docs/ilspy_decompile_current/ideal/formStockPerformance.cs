...
public class formStockPerformance : FormControl
{
	private class Record
	{
		public string Description;

		public string NetPerValue;

		public string NetDifValue;
		...
		public Color NetPerColor;

		public Color NetDifColor;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	public formStockPerformance(int leftX, int topX, string symbolX, cxPage.Step pageparamsX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_Activated(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_Deactivate(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formStockPerformance_SizeChanged(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private Color ConvertStatusToColor(int statusX)
	{
