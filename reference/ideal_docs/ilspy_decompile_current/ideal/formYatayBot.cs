...
public class formYatayBot : Form
{
	public static formYatayBot Referans;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formYatayBot_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formYatayBot_Resize(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formYatayBot_SizeChanged(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formYatayBot_FormClosed(object sender, FormClosedEventArgs e)
	{
	}
