...
public class formGridBot : Form
{
	public static formGridBot Referans;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formGridBot_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formGridBot_Resize(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formGridBot_SizeChanged(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formGridBot_FormClosed(object sender, FormClosedEventArgs e)
	{
	}
