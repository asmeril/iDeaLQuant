...
public class formParaViopEkle : Form
{
	...
	public formParaViopEkle()
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formParaViopEkle_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void mybtnKaydet__OnClick(object sender, EventArgs e)
	{
	}
