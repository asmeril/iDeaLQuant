...
public class formEmirSira : FormControl
{
	...
	private bool PgcRecalculateBool;

	private double PgcVal;

	private double PgcLot;

	private double PgcAvr;

	private string PgcBuyer;

	private string PgcSeller;
	...
	private Panel panelPgc;

	[MethodImpl(MethodImplOptions.NoInlining)]
	public formEmirSira(int leftX, int topX, string symbolX, cxPage.Depth pageparamsX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_Activated(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_Deactivate(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_MouseWheel(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formEmirSira_SizeChanged(object sender, EventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void panelMoneyflow_MouseDoubleClick(object sender, MouseEventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void panelPgc_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void panelPgc_MouseDoubleClick(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void panelPgc_Paint(object sender, PaintEventArgs e)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void EmirSiraRefreshReceived(string symbolX, string strX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void EmirSiraUpdateReceived(string symbolX, string strX)
	{
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void panelPgc_MouseMove(object sender, MouseEventArgs e)
	{
	}
