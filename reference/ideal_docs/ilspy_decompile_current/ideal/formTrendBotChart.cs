...
public class formTrendBotChart : Form
{
	public static formTrendBotChart Referans;

	private TrendBotClass TrendBotItem;
	...
	public formTrendBotChart(TrendBotClass TrendBotX)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_Load(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_FormClosed(object sender, FormClosedEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_Resize(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_SizeChanged(object sender, EventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_Paint(object sender, PaintEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_MouseDown(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_MouseMove(object sender, MouseEventArgs e)
	{
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private void formTrendBotChart_MouseWheel(object sender, MouseEventArgs e)
	{
	}
